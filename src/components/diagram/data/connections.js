export const connections = [
  {
    ...
    to: 'pm-top-level',
    label: 'Power Query',
    description: 'Bi-directional data flow between configuration and project management',
    bidirectional: true,
  },
  {
    from: 'config-matrix',
  ...
  },
  {
    ...
    to: 'master-receiving',
    label: 'Power Query',
    description: 'Bi-directional: PRs exposed for receiving, qty/dates/locations fed back',
    fromSide: 'bottom',
    toSide: 'top',
    bidirectional: true,
  },
